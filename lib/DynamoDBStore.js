...
export default class DynamoDBStore extends Store {
  ...
  setOptionsAsInstanceAttributes (options: Object): void {
    ...
    if (table.rangeKey) this.rangeKey = table.rangeKey
  ...
  createTable (): Promise<boolean> {
    ...
    if (this.rangeKey) {
      params.KeySchema.push({ AttributeName: this.rangeKey, KeyType: 'RANGE' })
  ...
  set (sid: string, sess: Object, callback: Function): void {
    try {
      ...
      if (this.rangeKey) params.Item[this.rangeKey] = sessionId
  ...
  async get (sid: string, callback: Function): Promise<void> {
    try {
      ...
      if (this.rangeKey) params.Key[this.rangeKey] = sessionId
